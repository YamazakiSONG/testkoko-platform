export const TESTS = [
    ...
    questions: [
      ...
      },
      {
        ...
        answers: [
          ...
          {
            type: "I",
            content: "동료를 구하다가 잘못하면 나도 죽을 수 있다. \n안타깝지만 나랑 친한 동료가 아니라면 버린다.",
          },
        ],
      },
      {
        which: "SN",
        question: "내가 평생 살아온 벽 안에 거인이 있다는\n사실을 알게 되었을 때, 당신의 심정은?",
        answers: [
          {
            type: "S",
      ...
      },
      {
        ...
        answers: [
          ...
          {
            type: "N",
            content: "거인을 죽이는 것이 즐거움으로 바뀐다는 것은\n이 전투의 본질을 잊어버렸다는\n의미일 수 있다고 생각한다.",
          },
        ],
      },
      {
      ...
      {
        which: "TF",
        question: "주인공 에렌은 결국 자신이 \n죽어야 모든 상황이 끝나는걸 알고있다.\n만약 너가 에렌이라면 어떻게 행동할건가?",
        answers: [
          {
            type: "T",
            content: "내가 죽는 것이 인류와 세계에 이익을 준다면\n기꺼이 죽음을 감수한다.",
          },
          {
            type: "F",
            content: "인생에서 제일 중요한 건 나 자신이다.\n내가 왜 남들을 위해 희생해야 하는지\n생각하며 결정을 망설인다.",
          },
        ],
      },
  ...
  // attackOfTitanMBTIEng
  {
    ...
    {
      which: "EI",
      question: "You’re enjoying a quiet day\nwhen suddenly the Wall is\nbreached and Titans pour in.\nWhat’s your move?",
      answers: [
        {
          type: "E",
          content: "Alert the people around you and rally your comrades to take the Titans down together."
        },
        {
          type: "I",
          content: "First tally how many Titans made it inside,\nwork out a plan in your head,\nthen head out solo to wipe them out."
        }
      ]
    },
    {
      which: "EI",
      question: "On the eve of your first expedition\nbeyond the Walls as a member\nof the Scout Regiment,\nhow will you spend the night?",
      answers: [
        {
          type: "E",
          content: "Talk with your comrades, share your fears,\nand steel your resolve together."
        },
        {
          type: "I",
          content: "Honestly, you’re terrified…\nso you start plotting an escape plan\nto ditch the Scouts before dawn."
        }
      ]
    },
    {
      which: "EI",
      question: "A comrade has been seized by\na Titan and is seconds from death.\nWhat do you do?",
      answers: [
        {
          type: "E",
          content: "No hesitation—rush straight\nat the Titan to rescue them."
        },
        {
          type: "I",
          content: "If I try to save them, I might die too.\nHarsh as it is, I’d leave them\nbehind unless we’re close."
        }
      ]
    },
    {
      which: "SN",
      question: "You learn that Titans have been\nhiding inside the very Wall\nyou’ve lived behind all your life.\nhow do you feel?",
      answers: [
        {
          type: "S",
          content: "Total shock—the monsters I dreaded most were right next to us all along."
        },
        {
          type: "N",
          content: "I need to know why Titans are embedded in the Wall, so I start digging for solid evidence and information."
        }
      ]
    },
    {
      which: "SN",
      question: "You’ve been slaying Titans to save humanity, but lately you catch yourself enjoying the slaughter itself. What goes through your head?",
      answers: [
        {
          type: "S",
          content: "I keep repeating to myself that killing Titans is still essential for humanity’s survival."
        },
        {
          type: "N",
          content: "If the act of killing has become fun, maybe it means I’ve lost sight of what this fight is really about."
        }
      ]
    },
    {
      which: "SN",
      question: "You find out that the comrades you’ve trained with to slay Titans—Reiner and Bertholdt—are actually Titans themselves. How do you react?",
      answers: [
        {
          type: "S",
          content: "Drawing on the skills and intel I picked up while living beside them, I drop straight into battle mode."
        },
        {
          type: "N",
          content: "Anger and betrayal hit me hard, but I keep my cool and ask: why reveal their true identity now?"
        }
      ]
    },
    {
      which: "TF",
      question: "During the assault on Marley’s coastline, you realize civilian casualties are all but inevitable. What do you do?",
      answers: [
        {
          type: "T",
          content: "If mission success is truly the only way to stave off even greater harm, I grit my teeth and stick to the plan."
        },
        {
          type: "F",
          content: "Even if it risks the entire operation, I’ll do everything I can to spare innocent lives."
        }
      ]
    },
    {
      which: "TF",
      question: "Levi asks you and your comrades to act as bait—essentially to die—so the Titans can be taken down. What goes through your mind?",
      answers: [
        {
          type: "T",
          content: "If our sacrifice is truly necessary to achieve the greater goal, I’ll accept it, no matter how hard it is."
        },
        {
          type: "F",
          content: "My own life comes first. If I’m dead, nothing else matters, so I refuse the order."
        }
      ]
    },
    {
      which: "TF",
      question: "You discover—just as Eren does—that the only way to end everything is to sacrifice yourself. If you were in his shoes, what would you do?",
      answers: [
        {
          type: "T",
          content: "If my death genuinely serves humanity and the world, I’d accept it without hesitation."
        },
        {
          type: "F",
          content: "My own life comes first; I’d waver, asking why I have to give it up for others."
        }
      ]
    },
    {
      which: "JP",
      question: "Your comrade is forcibly injected with Titan serum by the enemy and turns into a mindless Titan. How do you react?",
      answers: [
        {
          type: "J",
          content: "They were my comrade once, but now they’re a Titan—I put them down on the spot."
        },
        {
          type: "P",
          content: "Even as a Titan they’re still my comrade. I search for any other way to save them."
        }
      ]
    },
    {
      which: "JP",
      question: "You have only one Titan serum—enough to save either Commander Erwin or your close friend Armin. What do you do?",
      answers: [
        {
          type: "J",
          content: "I bring Commander Erwin back; his strategic value is irreplaceable."
        },
        {
          type: "P",
          content: "Friendship comes first, so I choose to save Armin."
        }
      ]
    },
    {
      which: "JP",
      question: "Mikasa ends Eren’s life, and after countless human sacrifices, peace finally settles over the world. How do you feel?",
      answers: [
        {
          type: "J",
          content: "It took a huge sacrifice, but peace is here at last—so I focus on planning for the future and living well."
        },
        {
          type: "P",
          content: "Even with peace, I keep wondering whether this ending was truly right, or if another path might have existed."
        }
      ]
    }
  ],
  ...
  // attackOfTitanMBTIJP
  {
    ...
    {
      which: "EI",
      question: "平穏な日常を送っていたところ、壁が破られ巨人が出現しました。あなたはどう行動しますか？",
      answers: [
        {
          type: "E",
          content: "周りの人に知らせ、仲間と連携して巨人を討伐しに向かう。"
        },
        {
          type: "I",
          content: "壁内に侵入した巨人の数を把握し、倒すための戦略を頭の中で練ってから一人で行動する。"
        }
      ]
    },
    {
      which: "EI",
      question: "調査兵団として初めて壁外遠征に出発する前夜、あなたはどのように夜を過ごしますか？",
      answers: [
        {
          type: "E",
          content: "仲間と語り合い、不安を分かち合いながら気持ちを引き締める。"
        },
        {
          type: "I",
          content: "正直、怖すぎる……今のうちに調査兵団から逃げ出す方法を考える。"
        }
      ]
    },
    {
      which: "EI",
      question: "仲間が巨人に捕まって命の危機に瀕しています。あなたはどう行動しますか？",
      answers: [
        {
          type: "E",
          content: "考える間もなく、仲間を助けるために巨人へ突っ込む。"
        },
        {
          type: "I",
          content: "助けに行けば自分も死ぬかもしれない。残念だが親しい仲間でなければ見捨てる。"
        }
      ]
    },
    {
      which: "SN",
      question: "生まれてからずっと頼ってきた壁の中に巨人がいると知ったとき、あなたの気持ちは？",
      answers: [
        {
          type: "S",
          content: "ずっと恐れていた巨人がすぐそばにいたと分かり、ものすごい衝撃を受ける。"
        },
        {
          type: "N",
          content: "なぜ巨人が壁の中に潜んでいるのか根本的な理由を知るため、証拠や情報を集め始める。"
        }
      ]
    },
    {
      which: "SN",
      question: "人類を救うために巨人を討伐していたはずが、いつの間にかその虐殺自体を楽しんでいる自分に気づいた──そんなとき、あなたの胸に浮かぶのは？",
      answers: [
        {
          type: "S",
          content: "巨人を倒すことは現実に人類を救うための大事な使命だと、何度も自分に言い聞かせる。"
        },
        {
          type: "N",
          content: "巨人を殺す行為が快感に変わったのなら、この戦いの本質を見失った証かもしれないと考える。"
        }
      ]
    },
    {
      which: "SN",
      question: "一緒に巨人討伐の訓練を重ねてきた仲間――ベルトルトとライナー――が実は巨人だったと知ったとき、あなたはどう反応しますか？",
      answers: [
        {
          type: "S",
          content: "彼らと過ごしながら身につけた技術と情報を生かし、即座に戦闘態勢に入る。"
        },
        {
          type: "N",
          content: "怒りと裏切りを感じつつも、まずは冷静になり、なぜ今になって正体を明かしたのか考える。"
        }
      ]
    },
    {
      which: "TF",
      question: "マーレ海岸侵攻作戦で敵と交戦中、民間人の犠牲が避けられないと分かったとき、あなたはどうしますか？",
      answers: [
        {
          type: "T",
          content: "最終的に作戦の成功がより大きな被害を防ぐ道なら、やむを得ず計画どおり進める。"
        },
        {
          type: "F",
          content: "たとえ作戦が失敗する危険があっても、無実の人々の犠牲はできる限り避ける。"
        }
      ]
    },
    {
      which: "TF",
      question: "巨人を倒すための囮になって仲間と一緒に死んでほしい――そうリヴァイに頼まれたとき、あなたはどう考えますか？",
      answers: [
        {
          type: "T",
          content: " 理性的に見て、その犠牲が大きな目的を果たすために不可欠なら受け入れる。"
        },
        {
          type: "F",
          content: "人生でいちばん大切なのは自分だ。自分が死んだらすべて無意味なので命令を拒否する。"
        }
      ]
    },
    {
      which: "TF",
      question: "主人公エレンのように、自分が死ねばすべてが終わると悟ったとき、もしあなたがエレンだったらどうしますか？",
      answers: [
        {
          type: "T",
          content: "自分の死が人類と世界のためになるのなら、進んでその運命を受け入れる。"
        },
        {
          type: "F",
          content: "人生でいちばん大切なのは自分だ。他人のために犠牲になる必要があるのか考え込み、決断をためらう。"
        }
      ]
    },
    {
      which: "JP",
      question: "仲間が敵に巨人化注射を打たれ、無垢の巨人に変えられてしまいました。あなたはどう反応しますか？",
      answers: [
        {
          type: "J",
          content: "かつては仲間でも今は巨人。迷わず討ち取る。"
        },
        {
          type: "P",
          content: "巨人になっても仲間は仲間だ。救う手立てがないか探す。"
        }
      ]
    },
    {
      which: "JP",
      question: "巨人化注射はひとつだけ。エルヴィン団長と親友アルミン、どちらか一人しか救えないとしたらどう決めますか？",
      answers: [
        {
          type: "J",
          content: "圧倒的な戦略的価値を持つエルヴィン団長を蘇生させる。"
        },
        {
          type: "P",
          content: "自分にとって最も大切なのは友情だ。親友アルミンを助ける。"
        }
      ]
    },
    {
      which: "JP",
      question: "ミカサが最後にエレンを殺し、多くの人類の犠牲の末に平和が訪れました。そのとき、あなたの胸に湧く感情は？",
      answers: [
        {
          type: "J",
          content: "大きな犠牲は払われたものの、今は平和が来た。これからの人生を計画し、前向きに生きていく。"
        },
        {
          type: "P",
          content: "平和は訪れたけれど、この結末が本当に正しかったのか、他の選択肢はなかったのか考え続ける。"
        }
      ]
    }
  ],
  ...
  // areYouT
  {
    info: {
      ...
      mainImage: "https://images.testkoko.com/T_areYouT/mainThumb/areYouT_intro_thumb_ko.avif",
      thumbImage: "https://images.testkoko.com/T_areYouT/mainThumb/areYouT_main_thumb_ko.avif",
      lang: "Kor",
      category: "characteristic",
      locale: "ko_KR",
      creator: "테스트코코",
      keywords: "MBTI 테스트,T성향 측정,너 T발 C야?,T발놈,심리테스트,테스트코코,TestKOKO"
    },
    questions: [
      {
        question: '친구가 "나 이번 시험 1점차이로 떨어져서 \n너무 속상해ㅠ"라고 말한다.\n이때 너의 반응은?',
        answers: [
          {
            score: 0,
            content: '1점 차이로 떨어졌다고? 그건 온 우주가 "이번에는 좀 쉬어"라고 말하는 거야. 너무 슬퍼하지마'
          },
          {
            score: 1,
            content: '슬프겠지만 우선 감정은 나중에 처리하고,\n일단 어디서 1점이 틀렸는지 분석부터 하자.'
          },
          {
            score: 2,
      ...
      },
      {
        ...
        answers: [
          ...
          {
            score: 1,
            content: '화이팅 한마디로 힘들게 해결될 것 같으면\n전 세계에 우울증 있는 사람은 없을걸?'
          },
          {
            score: 2,
            content: '그런 실질적인 도움 안 되는 말 할 바에는\n차라리 엑셀로 내 문제 정리해 줘.'
          }
        ]     
      },
      {
        question: '친구가 연인과 헤어지고 혼자 술먹으면서 나한테 전화를 한다. 이때 너의 반응은?',
        answers: [
          {
            score: 0,
            content: '나가기 귀찮지만 친구가 힘들어할까봐\n같이 술 먹으러 나간다.'
          },
          {
            score: 1,
            content: '문제는 구조에 있어.\n전화로 감정을 나누기 전에 이별 사유를 표로 정리해 봐.'
          },
          {
            score: 2,
            content: '실연 감정은 일시적이지만 음주는 간과 신장에 장기적 대미지를 줘. 슬픈 건 알지만 이성적으로 생각해'
          }
        ]
      },
      {
        question: '친구가 "나 우울해서 빵 샀어ㅠ"라고 말한다.\n이때 너의 반응은?',
        answers: [
          {
            score: 0,
            content: '빵을 사 먹음으로써 우울증이 해결되면\n가성비 최고인데?'
          },  
          {
            score: 1,
            content: '빵은 우울을 해결하지 못해.\n다만 혈당을 일시적으로 납득시킬 뿐이지.'
          },
          {
            score: 2,
      ...
      {
        question: '친구가 "나 머리색 바꿨어. 어때?"라고 말한다.\n이때 너의 반응은?',
        answers: [
          {
            score: 0, 
          ...
          {
            score: 1,
            content: '고작 머리색 하나 바뀌었다고 너의 인생이 달라지는 건 아니지만 실험 정신은 인정해.'
          },
          {
            score: 2,
            content: '데이터 없이는 판단 불가능해.\n염색 전과 후 사진, 주변 반응 표본조사를 제출해 줘.'
          }
        ]
      },
      {
        question: '친구가 "나 시험 망했어ㅠ"라고 말한다.\n이때 너의 반응은?',
        answers: [
          {
            score: 0, 
            content: '망했다는 건 실패가 아니라 데이터야.\n다음 시험 전략 짤 수 있는 데이터 수집 성공했으니 완전 럭키비키잖아?'
          },
          {
            score: 1,
            content: '망한 원인을 분석해 봤어?\n내 생각에는 너는 지식을 학습하기 위한 공부가 아닌 보여주기식 공부를 한거 같아.'
          },
          {
            score: 2,
            content: '"망했다"라는 정의를 먼저 내려야 할 것 같아. 몇 점 이하가 망한 건데? 정확한 수치로 말해봐'
          }
        ]
      },
      {
        question: '친구가 "내일까지 숙제를 해야 하는데 지금 너무 졸려... 어떡하지?"라고 말한다.\n이때 너의 반응은?',
        answers: [
          {
            score: 0, 
            content: '지금 잘 거면 최소 REM 수면 도달 시간이라도 \n고려하고 자는게 좋지 않을까?'
          },
          {
            score: 1,
            content: '당연히 숙제를 해야지... 이성 회로 고장났어? 리부트 하자.'
          },    
          {
            score: 2,
            content: '졸린 건 생물학적 오류지만 과제를 미루는건 \n앞으로 너의 인생 시스템이 실패가 될 수 있어.\n뭐가 더 치명적인지 계산해봐.'
          }
        ]
      },  
      {
        question: '친구와 함께 감동적인 드라마 결말을 봤다.\n이후 너의 반응은?',
        answers: [
          {
            score: 0,
          ...
          {
            score: 1,
            content: '눈에서 흐르는 눈물은 뇌의 일시적 화학 반응이야. \n눈물은 단지 염분이 포함된 H2O일 뿐이지.'
          },
          {
            score: 2,
      ...
      {
        question: '친구가 "너 공부 별로 안 한 거 같은데 시험 성적이 잘 나왔네?"라고 말한다.\n이때 너의 반응은?',
        answers: [
          {
            score: 0,
          ...
          {
            score: 2,
            content: '효율이란 걸 모르냐?\n같은 시간 공부해도 넌 흡수율 10%, 난 99%. 사람마다 뇌의 지능은 다르단걸 알아두길 바래.'
          }
        ]
      },
      {
        question: '친구가 "나 돈 모아서 핸드폰 샀어!"라고 말한다.\n이때 너의 반응은?',
        answers: [
          {
            score: 0,
  ...
  },
  {
    ...
    questions: [
      {
        question: "후배가 출근 전 늦을 거 같다고 연락이 온다.\n그래서 나에게 지각 안 한 것처럼 보이기 위해\n컴퓨터 전원을 켜놔달라고 한다.\n이때 나의 반응은?",
        answers: [
          {
            score: 0,
            content: "그 정도야~ 켜놔줄게. 대신 넌 오늘 커피 사!"
          },
          {
            score: 1,
            content: "하하하 그런 창의적인 부탁도 있구나~ ㅎㅎ \n근데 회사는 학교랑 다르지 않냐?"
          },
          {
            score: 2,
            content: "그럼 출근체크도 내가 대신해 줄 테니\n나한테 지문도 남겨줄래?라고 비꼰다."
          }
        ]
      },
      {
        question: "후배가 쉬는 시간에 혼자 카페에\n가서 자기 커피만 사 온다.\n이때 나의 반응은?",
        answers: [
          {
            score: 0,
            content: "요즘은 다 개인주의니깐 그럴 수도 있지~\n(그리고 다음엔 같이 커피 사러 가자고 먼저 말해줌)"
          },
          {
            score: 1,
            content: "오호... 혼자만 커피라ㅎㅎ \n역쉬 MZ~"
          },
          {
            score: 2,
            content: "요즘은 혼자 먹고 혼자 사는 세상이냐? \n커피 한 잔에 동료애가 있는 거야."
          }
        ]     
      },
      {
        question: "팀장인 내가 오늘 커피를 사기로 한다. \n이때 후배가 가장 비싼 8000천원\n프라푸치노를 주문한다.이때 나의 반응은?",
        answers: [
          {
            score: 0,
            content: "와우~ 역시 요즘 MZ는 남다르다! \n다음엔 나도 저거 마셔봐야지~😊"
          },
          {
            score: 1,
            content: "와~ 나는 2000원짜리 아아 마시는데~ \n후배님은 간이 크시네?라고 비꼰다."
          },
          {
            score: 2,
            content: "야 이 자식아!!\n 프라푸치노면 회식 메뉴야. \n너는 그냥 회사 정수기에서 물이나 마셔."
          }
        ]
      },
      {
        question: "직장 동료들이랑 점심 식사를 하러 갔는데\n후배가 수저 세팅을 하지 않고 가만히 있는다.\n이때 나의 반응은?",
        answers: [
          {
            score: 0,
            content: "그냥 내가 수저 세팅한다.\n(누가 수저를 놓든 중요하지 않음)"
          },  
          {
            score: 1,
            content: "요즘은 수저도 각자 챙기는 시대인가~?\n나 때는 서로 챙겨주는 맛이 있었는데ㅎㅎ\n(웃지만 젓가락 끝이 살짝 떨림)"
          },
          {
            score: 2,
            content: "야.뭐 하냐? 회사 생활에 기본이 안 됐네.\n(그리고 후배가 수저 놓고도 ‘넌 탈락’ 표시 눈빛 쏨)"
          }
        ]
      },
      {
        question: "회의 시간에 팀장인 나는 종이에 메모하는데\n후배 놈은 아이패드에 메모를 한다.\n이때 속 마음은?",
        answers: [
          {
            score: 0, 
            content: "아이패드는 필기 잘 돼요? 나도 하나 살까?\n(진심으로 관심 있고, 손글씨보다 깔끔한 걸 부러워함)"
          },
          {
            score: 1,
            content: "아이패드 좋지. 근데 말이야… \n종이에 써야 기억에 남는 법이야~\n(자신의 메모지는 아무것도 적혀 있지 않음)"
          },
          {
            score: 2,
            content: "오...? 아이패드 써요?\n그거로 뭐 하는지 난 몰라서 불안하더라~\n(그리고 본인 메모엔 ‘점심 김치찌개’ 적혀 있음)"
          }
        ]
      },
      {
        question: '회의 중 팀장인 나의 의견에 새파란 신입이\n "그건 좀 아닌 것 같은데요?"라고 말한다면?',
        answers: [
          {
            score: 0, 
            content: '오~ 그럼 어떻게 하면 더 좋을까? 말해봐!\n(진심으로 피드백 수용에 열린 인간 스펀지)'
          },
          {
            score: 1,
            content: '음~ 그래?\n그럼 다음 주 기획안은 네가 짜보자!ㅎㅎ\n(입꼬리는 올라가지만 눈썹은 안 내려감)'
          },
          {
            score: 2,
            content: '어디서 신입 나부랭이가?...\n이건 경험이 필요한 문제이니 너는 조용히 있어'
          }
        ]
      },
      {
        question: "신입이 점심 메뉴로 마라탕을 예약해놨다.\n이때 당신의 반응은?",
        answers: [
          {
            score: 0, 
            content: "오~ 마라탕 좋지! 혀 마비돼도 행복하더라고요~\n(그리고 후식으로 탕후루도 먹는다.)"
          },
          {
            score: 1,
            content: "마라탕…? 음~ 나도 먹긴 먹는데...\n다음엔 국밥도 고려해 보자!\n(하지만 마라 국물은 거의 안 건드림)"
          },    
          {
            score: 2,
            content: "마라탕은 중국 애들이 먹는 거 아냐?\n나 때는 김치찌개에 계란찜이 국룰이었지."
          }
        ]
      },  
      {
        question: "후배가 에어팟을 끼고 일하고 있는 걸 목격했다. \n이때 나의 속 마음은?",
        answers: [
          {
            score: 0,
            content: "신문물에 관심을 보이면서 좋냐고 물어봄.\n(그리고 슬쩍 플레이리스트 공유 요청함)"
          },
          {
            score: 1,
            content: '약간의 마음속 불편함을 느낌.\n하지만 직접 말은 안 하고, 퇴근 후 갑자기\n"소통의 중요성"을 주제로 톡 보냄'
          },
          {
            score: 2,
            content: "바로 회의실로 소환.\n이후 그 후배의 인사평가는 음소거됨"
      ...
      {
        question: "회식자리에서 후배가 내가 주는 술을 \n마시지 않고 제로 음료만 마시고 있다.\n이때 속 마음은?",
        answers: [
          {
            score: 0,
            content: "오~ 제로 음료 좋죠!\n요즘은 알쓰가 대세라던데요?\n(그리고 본인도 제로콜라로 건배함)"
          ...
          {
            score: 1,
            content: "오~ 요즘은 술 안 먹는 게 트렌드구나~ \n나도 한때는 그랬지..."
          },
          {
            score: 2,
            content: '상사가 주는 술은 예의상 무조건 마시는거야.\n내가 주는 술은 "너를 아끼는 마음"이니깐 한 잔 받아.'
          }
        ]
      },
      { 
        question: "퇴근 시간 10분전 짐을 싸는 후배를 목격한다.\n이때 나의 반응은?",
        answers: [
          {
            score: 0,
            content: "나도 후배따라서 같이 짐을 싼다.\n(은근히 짐 싸는 속도에 경쟁심 느낀다)"
          },
          {
            score: 1,
            content: "음~ 시계는 10분 느리게 봐야 진짜 프로인데ㅎㅎ\n(웃지만 한쪽 눈썹이 위로 올라가 있음)"
          },
          {
            score: 2,
            content: "뭐하냐? 퇴근 10분 전은 짐을 정리하는 시간이 \n아니라 오늘한 업무를 정리하는\n또 다른 일의 시작 시간이야.\n다시 짐 풀어!!"
          }
        ]
      },
    ],
