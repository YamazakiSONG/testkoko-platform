export const TESTS = [
  ...
  // areYouT
  {
    ...
    questions: [
      ...
      {
        question: '친구가 연인과 헤어지고 혼자 술먹고 \n나한테 전화를 한다.이때 너의 반응은?',
        answers: [
          {
            score: 0,
          ...
          {
            score: 1,
            content: '헤어짐이 일어난 이유는 구조에 있어.\n나한테 전화로 감정을 나누지 말고\n이별 사유를 표로 정리해 봐.'
          },
          {
            score: 2,
            content: '실연 감정은 일시적이지만 음주는\n간과 신장에 장기적 대미지를 줘.\n슬픈 건 알지만 이성적으로 생각해'
          }
        ]
      },
      {
        ...
        answers: [
          ...
          {
            score: 2,
            content: '우울함을 빵으로 해결하는 건 컴퓨터 오류에\n과자 부으면 고쳐질 거라는 믿음이랑 비슷해'
          }
        ]
      },
      {
        ...
        answers: [
          ...
          {
            score: 1,
            content: '고작 머리색 하나 바뀌었다고 너의 인생이\n달라지는 건 아니지만 실험 정신은 인정해.'
          },
          {
            score: 2,
      ...
      },
      {
        ...
        answers: [
          {
            score: 0, 
            content: '망했다는 건 실패가 아니라 데이터야.\n다음 시험 전략 짤 수 있는 데이터 수집\n성공했으니 완전 우럭키비키잖아?'
          },
          {
            score: 1,
            content: '망한 원인을 분석해 봤어?\n내 생각에는 너는 지식을 학습하기 위한\n공부가 아닌 보여주기식 공부를 한거 같아.'
          },
          {
            score: 2,
      ...
      {
        question: '친구가 "내일까지 숙제를 해야 하는데\n지금 너무 졸려... 어떡하지?"라고 말한다.\n이때 너의 반응은?',
        answers: [
          {
            score: 0, 
            content: '당연히 숙제를 해야지... \n이성 회로 고장났어? 리부트 하자.'
      ...
      },  
      {
        ...
        answers: [
          ...
          {
            score: 2,
            content: '감동? 그건 뇌에서 나오는 일시적 화학 반응이야.\n넷플릭스한테 정서 조종 당한 거지.'
          }
        ]
      },
      {
        question: '친구가 "너 공부 별로 안 한 거 같은데\n시험 성적이 잘 나왔네?"라고 말한다.\n이때 너의 반응은?',
        answers: [
          {
            score: 0,
          ...
          {
            score: 2,
            content: '효율이란 걸 모르냐?\n같은 시간 공부해도 넌 흡수율 1%, 난 99%.\n사람마다 뇌의 지능은 다르단걸 알아두길 바래.'
          }
        ]
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      {
        question: "후배가 쉬는 시간에 혼자 카페에 가서\n자기 커피만 사 온다. 이때 나의 반응은?",
        answers: [
          {
            score: 0,
