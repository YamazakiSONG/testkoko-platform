export const TESTS = [
    ...
    questions: [
...

      {
        ...
        answers: [
          ...
          {
            type: "P",
            content: "거인이 되었더라도 나의 동료이다. 다른 방법은 없는지 찾아본다.",
          },
        ],
      },
      {
  ...
  // areYouT
  {
    ...
    questions: [
      {
        which: "TF",
        question: "나 이번 시험 1점차이로 떨어졌어. 너무 속상해ㅠ",
        answers: [
          {
            score: 0,
      ...
      {
        which: "TF",
        question: "내가 힘든 일이 있어서 친구가 '화이팅 해~! 잘될 거야!'라고 위로해준다.",
        answers: [
          {
            score: 0,
            content: "실질적인 도움은 되지 않지만 말이라도 고맙다."
          },
          {
            score: 1,
            content: "'화이팅으로 해결되면 전 세계에 우울증 있는 사람은 없을걸?'이라고 답한다"
          },
          {
            score: 2,
            content: "그런 실질적인 도움 안되는 말 할 바에는 차라리 엑셀로 내 문제 정리해 줘."
          }
        ]     
      },
      {
        which: "TF",
        question: "친구가 연인과 헤어지고 혼자 술먹으면서 나한테 전화를 한다.",
        answers: [
          {
            score: 0,
            content: "나가기 귀찮지만 친구가 힘들어할까 봐 같이 술 먹으러 나간다."
          },
          {
            score: 1,
            content: "문제는 구조에 있어. 전화로 감정을 나누기 전에, 이별 사유를 표로 정리해 봐."
          },
          {
            score: 2,
            content: "실연 감정은 일시적이지만 음주는 간과 신장에 장기적 대미지를 줘. 냉정하게 판단하자"
          }
        ]
      },
      {
        which: "TF",
        question: "나 우울해서 빵 샀어ㅠ",
        answers: [
          {
            score: 0,
      ...
      },
      {
        ...
        answers: [
          ...
          {
            score: 1,
            content: "머리색이 바뀌었다고 인생의 효율이 올라가는 건 아니지만 실험 정신은 인정해."
          },
          {
            score: 2,
            content: "데이터 없이는 판단 불가능해. 전과 후 사진, RGB 값, 주변 반응 표본조사를 제출해 줘."
          }
        ]
      },
      {
        ...
        answers: [
          {
            score: 0, 
            content: "망했다는건 실패가 아니라 데이터야. 다음 시험 전략 짤 수 있는 데이터 수집 성공!"
          },
          {
            score: 1,
          ...
          {
            score: 2,
            content: "망했다는 정의를 먼저 내려야지. 몇 점 이하가 망한 건데? 정확한 수치로 말해봐"
          }
        ]
      },
      {
      ...
      {
        which: "TF",
        question: "너 공부 별로 안 한 거 같은데 시험 성적이 잘 나왔네?",
        answers: [
          {
            score: 0,
            content: "통계적으로 네가 틀렸어. 난 매일 6시간씩 공부했는데 안 한 척한 것뿐이야. 관찰력이 부족하구나."
          },
          {
            score: 1,
            content: "효율이란 걸 모르냐? 같은 시간 공부해도 넌 흡수율 30%, 난 97%. 사람마다 뇌의 지능은 다르단걸 알아두길 바래."
          },
          {
            score: 2,
