export const TESTS = [
  ...
  // attackOfTitanMBTIEng
  {
    ...
    },
    {
      ...
      answers: [
        {
          type: "T",
          content: "As a result, if the success of the operation is the way to prevent further damage, it cannot be helped, but it proceeds as planned."
        },
        {
          type: "F",
          content: "Even if there is a risk that the operation will fail, the sacrifice of innocent people should be avoided as much as possible."
        }
      ]
    },
    {
      which: "TF",
      question: "To kill Titan, Levi asks you and your colleagues to sacrifice themselves with bait. What is your honest feelings at this time?",
      answers: [
        {
          type: "T",
    ...
    },
    {
      ...
      answers: [
        ...
        {
          type: "P",
          content: "Even if you're a giant, you're my colleague. See if there's any other way."
        }
      ]
    },
    {
    ...
    {
      which: "JP",
      question: "Mikasa kills his final boss and loved one, Ehren, and after countless sacrifices, peace finally comes. What are your feelings at this time?",
      answers: [
        {
          type: "J",
        ...
        {
          type: "P",
          content: "Peace has come, but I keep thinking if this is the right ending, or maybe there was another way."
        }
      ]
    }
  ],
  ...
  // attackOfTitanMBTIJP
  {
    ...
    },
    {
      ...
      answers: [
        ...
        {
          type: "I",
          content: "助けようとして自分も死ぬかもしれない。 残念ながら親しい同僚でなければ捨てる。"
        }
      ]
    },
    {
    ...
    {
      which: "SN",
      question: "人類を救うために巨人を殺しているのに、いつの間にか虐殺そのものに快感を感じている自分を発見する。 この時、あなたの考えは？",
      answers: [
        {
          type: "S",
        ...
        {
          type: "N",
          content: "殺すことに喜びを感じ始めているのは、この戦いの本質を見失った証拠かもしれないと思う。"
        }
      ]
    },
    {
    ...
    {
      which: "TF",
      question: "巨人を倒すためにリヴァイが仲間と一緒に餌食になって死んでほしいと頼んできた。 その時、あなたの率直な考えは？",
      answers: [
        {
          type: "T",
    ...
    {
      which: "TF",
      question: "主人公のエレンは、自分が死ななければすべてが終わらないということに気づいている。 もしあなたがエレンの立場だったらどうする？",
      answers: [
        {
          type: "T",
    ...
    {
      which: "JP",
      question: "同僚が巨人化注射を打って、知性のない巨人に変わってしまった。 この時、あなたはどのように反応するのか。",
      answers: [
        {
          type: "J",
        ...
        {
          type: "P",
          content: "巨人になっても私の仲間です。 他の方法はないか探してみます。"
        }
      ]
    },
    {
    ...
    {
      which: "JP",
      question: "ミカサが最後に最終ボスであり愛した人であるエレンを殺し、多くの犠牲の末に平和が訪れた。 その時あなたは何を感じますか？",
      answers: [
        {
          type: "J",
    ...
    questions: [
      ...
      },
      {
        ...
        answers: [
          ...
          {
            score: 2,
            content: '졸린 건 생물학적 오류지만 과제를 미루는건 앞으로 너의 인생 시스템이 실패가 될 수 있어.\n뭐가 더 치명적인지 계산해봐.'
          }
        ]
      },  
      {
        ...
        answers: [
          {
            score: 0,
            content: '드라마 기승전결 완성도는 높았지만 감정선이 쓸데없이 과하게 투자됐어'
          },
          {
            score: 1,
            content: '눈에서 흐르는 눈물은 뇌의 일시적 화학 반응이야. 눈물은 단지 염분이 포함된 H2O일 뿐이지.'
          },
          {
            score: 2,
      ...
      },
      {
        ...
        answers: [
          {
            score: 0,
            content: '"안 한 것 같아"는 너의 주관적 판단이야.\n순 공부 시간은 하루 평균 15시간이었어. 함부로 판단하지마 머저리야.'
          },
          {
            score: 1,
  ...
  },
  {
    ...
    questions: [
      {
        question: "후배가 아침에 연락이 와서 늦을 거 같다고 연락이 온다. 그래서 나에게 지각 안 한 것처럼 보이기 위해 컴퓨터 전원을 켜놔달라고 한다.\n이때 나의 반응은?",
        answers: [
          {
            score: 0,
            content: "ㅋㅋ 그 정도야~ 켜놔줄게. 대신 넌 오늘 커피 사~\n(장난 반, 협동심 반으로 넘김. 컴퓨터도 켜주고 자리도 정리해 줌)"
          },
          {
            score: 1,
          ...
          {
            score: 2,
            content: "그럼 출근체크도 내가 대신해 줄 테니 나한테 지문도 남겨줄래?라고 비꼬면서 화를 냄.\n(이후 단톡방에 “지각은 본인이 책임집시다^^” 글 올림)"
          }
        ]
      },
      {
        ...
        answers: [
          ...
          {
            score: 1,
            content: "ㅎㅎ 오~ 혼자만 커피라... 나도 입이 있었던 것 같은데~\n(커피의 시럽이 없는 것 같은 쓴 표정 지으며...)"
          },
          {
            score: 2,
            content: "요즘은 혼자 먹고 혼자 사는 세상이냐? 커피 한 잔에 동료애가 있는 거야. 이게 문화야.\n(그리고 그날 팀 단톡방에 ‘소통과 배려에 대한 좋은 글’ 공유함)"
          }
        ]     
      },
      {
      ...
      {
        question: "직장 동료들이랑 점심 식사를 하러 갔는데 후배가 수저 세팅을 하지 않고 가만히 있는다.\n이때 나의 반응은?",
        answers: [
          {
            score: 0,
            content: "어라? 수저 없네~ 내가 가져올게요~ 요즘 셀프잖아요ㅎㅎ\n(그리고 진심으로 아무렇지도 않음)"
          },  
          {
            score: 1,
            content: "요즘은 수저도 각자 챙기는 시대인가~? 나 때는 서로 챙겨주는 맛이 있었는데 말이지~ ^^\n(웃지만 젓가락 끝이 살짝 떨림)"
          },
          {
            score: 2,
      ...
      {
        question: "회의 시간에 팀장인 나는 종이에 메모하는데 후배 놈이 아이패드에 메모를 한다.\n이때 속 마음은?",
        answers: [
          {
            score: 0, 
            content: "오~ 아이패드 좋네. 필기 잘 돼요? 나도 하나 살까?\n(진심으로 관심 있고, 손글씨보다 깔끔한 걸 부러워함)"
          },
          {
            score: 1,
            content: "아이패드 좋지. 근데 말이야… 종이에 써야 기억에 남는 법이야~\n(자신의 메모지는 아무것도 적혀 있지 않음)"
          },
          {
            score: 2,
            content: "회의는 집중하는 시간이지 그림 그리는 시간 아니거든? 그거로 뭐 하는지 난 몰라서 불안하더라~\n(그리고 본인 메모엔 ‘점심 김치찌개’ 적혀 있음)"
          }
        ]
      },
      {
        ...
        answers: [
          {
            score: 0, 
            content: '오~ 반박도 가능하지! 그럼 어떻게 하면 더 좋을까? 말해봐!\n(진심으로 피드백 수용에 열린 인간 스펀지)'
          },
          {
            score: 1,
            content: '음~ 그래? 그럼 그 생각으로 다음 주 기획안은 네가 짜보자!\n(입꼬리는 올라가지만 눈썹은 안 내려감)'
          },
          {
            score: 2,
      ...
      },
      {
        ...
        answers: [
          ...
          {
            score: 1,
            content: "마라탕…? 음~ 나도 먹긴 먹는데~ 다음엔 국밥도 고려해 보자~ ㅎㅎ\n(하지만 마라 국물은 거의 안 건드림)"
          },    
          {
            score: 2,
      ...
      },  
      {
        ...
        answers: [
          {
            score: 0,
            content: "집중 잘 되나 보네~ 나도 예전엔 이어폰 끼고 노래 들으며 일했었지~\n(그리고 슬쩍 플레이리스트 공유 요청함)"
          },
          {
            score: 1,
            content: "약간의 마음속 불편함을 느낌.\n하지만 직접 말은 안 하고, 퇴근 후 갑자기 ‘소통의 중요성’을 주제로 톡 보냄"
          },
          {
            score: 2,
            content: "바로 회의실로 소환.\n이후 그 후배의 인사평가는 음소거됨"
      ...
      {
        question: "회식자리에서 후배가 상급자인 내가 주는 술을 하나도 안 먹고 제로 음료만 마시고 있다.\n이때 속 마음은?",
        answers: [
          {
            score: 0,
            content: "오~ 제로 음료 좋죠! 요즘은 알쓰가 대세라던데요? \n건강 챙기는 거 멋져요~\n(그리고 본인도 콜라로 건배함)"
          },
          {
            score: 1,
            content: "오~ 요즘은 술 안 먹는 게 트렌드구나~ \n나도 한때는 그랬지...\n(하지만 옆 사람한테만 따르며 슬쩍 시선은 그 후배에게 감)"
          },
          {
            score: 2,
      ...
      { 
        question: "퇴근 시간 10분전 짐을 싸는 후배를 목격한다. 이때 나의 반응은?",
        answers: [
          {
            score: 0,
          ...
          {
            score: 1,
            content: "음~ 시계는 10분 느리게 봐야 진짜 프로인데…ㅎㅎ(웃지만 한쪽 눈썹이 위로 올라가 있음)"
          },
          {
            score: 2,
            content: "야, 퇴근 10분 전은 짐을 정리하는 시간이 아니라 오늘한 업무를 정리하는 또 다른 일의 시작 시간이야. 다시 짐 풀어!"
          }
        ]
      },
    ],
