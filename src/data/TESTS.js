export const TESTS = [
  ...
  },
  {
    ...
    questions: [
      {
        question: "후배가 출근 전 늦을 거 같다고 연락이 온다. 그래서 나에게 지각 안 한 것처럼 보이기 위해 컴퓨터 전원을 켜놔달라고 한다.\n이때 나의 반응은?",
        answers: [
          {
            score: 0,
          ...
          {
            score: 2,
            content: "그럼 출근체크도 내가 대신해 줄 테니 나한테 지문도 남겨줄래?라고 비꼰다"
          }
        ]
      },
      {
      ...
      {
        question: "팀장인 내가 오늘 커피를 사기로 한다. \n이때 후배가 가장 비싼 8000천 원짜리 프라푸치노를 주문한다. 이때 나의 반응은?",
        answers: [
          {
            score: 0,
